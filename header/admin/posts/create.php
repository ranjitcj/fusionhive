...
<body>
    ...
    <div class="admin-wrapper">
        ...
        <div class="left-sidebar">
            <ul>
                <li><a href="index.php"><i class="fas fa-edit"></i> Manage Posts</a></li>
        ...
        <div class="admin-content">
            ...
            <div class="content">
                ...
                <form action="/header/admin/posts/post.php" method="post" enctype="multipart/form-data">
                    <div>
                    ...
                    <div>
                        <h3><label>Upload Image</label></h3>
